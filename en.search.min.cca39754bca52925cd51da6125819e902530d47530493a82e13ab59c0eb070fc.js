...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f8deb95d8a37466594fbc5aabe3fe610a67b4e4e6982f6805169c1a6453c2519.js',function(){input.required=false;search();});}
