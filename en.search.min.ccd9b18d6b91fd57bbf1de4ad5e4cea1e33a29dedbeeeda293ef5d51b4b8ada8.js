...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6eaa76ad06aec5e7a56abbf59afbeec8b64b4a2a7755ef3b0dce524d2931419e.js',function(){input.required=false;search();});}
