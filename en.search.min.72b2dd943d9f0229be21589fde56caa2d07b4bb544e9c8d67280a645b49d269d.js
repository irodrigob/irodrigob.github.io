...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.deefd7536cecbb7a60c6cbccea3b27298bedc6c2b066fc2b4e8b81a48a0b5a0f.js',function(){input.required=false;search();});}
