...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.07a02a04f45ec8b7bb21032d1523f7d1ac5743bd598442546025370afaefebca.js',function(){input.required=false;search();});}
