...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.8d7408dda93efaf6ffe555933bdae5dda67fb6694d4a576434227687679678fd.js',function(){input.required=false;search();});}
