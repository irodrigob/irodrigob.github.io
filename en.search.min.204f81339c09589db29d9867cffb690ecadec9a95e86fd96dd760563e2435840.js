...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.82671d72d3e2ceff78d4c7c66f6023cddde29f3b66f772ded82f5c56cecabca3.js',function(){input.required=false;search();});}
