...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.e3e9722de701a6279c16474573e8fae2dba51ed3b20733c1bafdc2098f463153.js',function(){input.required=false;search();});}
