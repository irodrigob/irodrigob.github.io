...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.c77d2f5c42aded8cb03358164d95a6f4bcb40fb537b82da0b93847753945a3a8.js',function(){input.required=false;search();});}
