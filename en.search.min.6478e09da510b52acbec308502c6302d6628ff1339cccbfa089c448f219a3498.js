...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.c7a0380a2108f4d27ffabb151c41cc1a0aa2e9c36c21c4c4958a370fbc2393ba.js',function(){input.required=false;search();});}
