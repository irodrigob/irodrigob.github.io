...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.5a4d131b7a9dbc8c9b32429817640ddbf06fe106909d969b5d02143a557ba7a1.js',function(){input.required=false;search();});}
