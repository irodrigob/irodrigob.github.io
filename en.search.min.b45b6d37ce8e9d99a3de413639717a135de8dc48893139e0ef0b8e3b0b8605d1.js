...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.c851385cc77aebce2b85a4999a756d7833c9da10bbfbd9ed799ad1a94636db87.js',function(){input.required=false;search();});}
