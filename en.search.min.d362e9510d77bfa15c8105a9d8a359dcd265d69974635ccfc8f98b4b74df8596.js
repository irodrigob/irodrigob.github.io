...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f2a5047443ca4d54646a669a69d06adfb840c282d40774004dc0843e56fd16cc.js',function(){input.required=false;search();});}
