...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.75d6576039a311e457000ae41a33228a115cdb6017e545e5ee9a2a56f2ba2fa4.js',function(){input.required=false;search();});}
