...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.8daf16a5057613a6b08267207cc407550babfd60220894a58be50ea15e358c34.js',function(){input.required=false;search();});}
