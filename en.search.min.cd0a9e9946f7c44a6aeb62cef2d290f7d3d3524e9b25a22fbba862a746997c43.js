...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.faeafb1128cd01bfa50bda02092a9bf175742d55ae7c4e9d9b032afbf24b8ac6.js',function(){input.required=false;search();});}
