...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3192c8b35271d7b40c01910c87fc585ce832c902e1282af1a535abc00a2c0a8d.js',function(){input.required=false;search();});}
