...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.78a688cc68857ce8dd2838effad8bbe1a3b31f63c2982a5c55f804400b8aefb7.js',function(){input.required=false;search();});}
