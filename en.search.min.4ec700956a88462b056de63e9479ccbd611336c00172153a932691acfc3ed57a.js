...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.79ae82f8405aeefddfe3e0012848be81881c56d7c46bd7d9def3d82e25039996.js',function(){input.required=false;search();});}
